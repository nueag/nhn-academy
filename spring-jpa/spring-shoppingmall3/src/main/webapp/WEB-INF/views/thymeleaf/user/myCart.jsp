        ...
        <table style="margin: 10px;">
            <tr>
                ...
                <td style="padding-right: 35px;">
                    <a href="/shippingInfo.do" class="btn btn-success">주문하기</a></td>
            </tr>
        </table>
    </div>
...
<script>
                ...
                function updateQuantity(index, action) {
                    ...
                    if (action === 'increase') {
                        ...
                        window.location.href = "/addCart.do?index=" + index;
                    } else if (action === 'decrease' && currentQuantity > 1) {
                        currentQuantity--;
                        quantityElement.value = currentQuantity;
                        window.location.href = "/deleteCart.do?index=" + index;
                    }
                }
</script>
<%
...
<tr>
    ...
    <th></th>
    <th>총액</th>
    <th id="sum" value="${sessionScope.sum}">${sessionScope.sum}</th>
    <th></th>
    <th></th>
</tr>
</table>
